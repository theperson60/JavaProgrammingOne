    ...
    */
    ...
    public static void main(String[] args)
    {
      ...
      while(!"q".equals(vote) || !"Q".equals(vote))
      {
          ...
          else if("N".equals(vote) || "n".equals(vote))
          {
              noVotes += 1;
          }
          else if ("Q".equals(vote) || "q".equals(vote))
          {
              break;
          }
          else if(!"Y".equals(vote) || !"y".equals(vote) ||  !"N".equals(vote) || !"n".equals(vote) || !"Q".equals(vote) || !"q".equals(vote))
          {
