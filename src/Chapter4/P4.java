...
public class P4
{
    ...
    */
    public static void main(String[] args) {
        ...
        else if (secondBidderTotal < firstBidderTotal)
        {
            System.out.println("The winner is " + secondBidder + ". The total cost will be " + formatter.format(secondBidderTotal));
        }
        else if (firstBidderTotal == secondBidderTotal && firstBidderHours < secondBidderHours)
        {
        ...
        else if (firstBidderTotal == secondBidderTotal && secondBidderHours < firstBidderHours)
        {
